class TemporalGraph:
    ...
    def get_edges_at_time(self, t):
        ...
        """
        return [(u, v) for u, v, t_start, _, t_end in self.edge_stream if t_start <= t <= t_end]
...
if __name__ == "__main__":
    ...
    tg.add_edge(1, 2, 1, 3)  # Arco tra 1 e 2 al tempo 1 con tempo di traversata 3 (t_end = 4)
    tg.add_edge(2, 3, 2, 2)  # Arco tra 2 e 3 al tempo 2 con tempo di traversata 2 (t_end = 4)
    tg.add_edge(3, 4, 3, 1)  # Arco tra 3 e 4 al tempo 3 con tempo di traversata 1 (t_end = 4)
    tg.add_edge(1, 3, 2, 4)  # Arco tra 1 e 3 al tempo 2 con tempo di traversata 4 (t_end = 6)
